...
router.get('/getAll',[verifyTokenAndAdmin],Async(orderController.getAllOrder))


//for order purpose
router.post('/orderItem',[verifyTokenAndAuthorization],Async(orderController.orderItem))
